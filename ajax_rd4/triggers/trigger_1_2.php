...
?>
                        ...
                        <div class="row padding-10">
                            ...
                            <form id="trigger_<?php echo $tipo."_".$sottotipo;?>" action="ajax_rd4/triggers/_act.php" novalidate="novalidate" method="POST" class="smart-form ">
                                <header>
                                    <strong>Funzione: </strong>Messaggio mail al raggiungimento di n articoli in un determinato ordine;<br>
                                ...
                                <fieldset class="col col-md-6">
                                    ...
                                    <?php }?>
                                    <section>
                                        <label class="label">2) Si raggiungono questi articoli:</label>
                                        <label class="input">
                                            <input type="text" maxlength="10" id="soglia_articoli" name="soglia_articoli">
                                        </label>
                                        <div class="note">
...
<script type="text/javascript">
    ...
    var $trigger_<?php echo $tipo."_".$sottotipo;?> = $('#trigger_<?php echo $tipo."_".$sottotipo;?>').validate({
            ...
            rules : {id_ordine:{required : true},soglia_articoli:{required : true}, name:{required:true}},
            messages : {id_ordine : {required : 'Per cortesia inserisci qualcosa...'},soglia_articoli:{required : 'non scherziamo, dai....'},name:{required:'Serve un nome'}},
