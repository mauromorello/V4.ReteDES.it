...
?>
                        ...
                        <div class="row padding-10">
                            ...
                            <form id="trigger_<?php echo $tipo."_".$sottotipo;?>" action="ajax_rd4/triggers/_act.php" novalidate="novalidate" method="POST" class="smart-form ">
                                <header>
                                    <strong>Funzione: </strong>Messaggio mail al raggiungimento di una soglia in euro di un certo ordine;<br>
                                ...
                                <fieldset class="col col-md-6">
                                    ...
                                    <section>
                                        <label class="label">2) Si supera la soglia di questi euro:</label>
                                        <label class="input">
