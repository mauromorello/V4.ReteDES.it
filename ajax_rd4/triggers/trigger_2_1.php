...
if(conv_datetime_from_db($row["scattato_il"])=="// 00:00"){
    ...
    $t .='<tr>';    
        ...
        //$t.='<td>'.$row["name"].'</td>';
        $t.='<td>'.conv_datetime_from_db($row["quando"]).'</td>';
        
        $t.='<td>'.user_fullname($row["id_utente"]).'</td>';
        $t.='<td>'.substr(strip_tags($row["testo_azione"]),0,50).'...</td>';
...
?>
                        ...
                        <div class="row padding-10">
                            ...
                            <form id="trigger_<?php echo $tipo."_".$sottotipo;?>" action="ajax_rd4/triggers/_act.php" novalidate="novalidate" method="POST" class="smart-form ">
                                <header>
                                    <strong>Funzione: </strong>Messaggio mail all'utente selezionato che parte in data futura;<br>
                                ...
                                <fieldset class="col col-md-6">
                                    ...
                                    <section>
                                        <label class="label">1) Quando si raggiunge questa data:</label>
                                        <label class="input">
                                            <input type="datetime" data-mask="99/99/9999 99:99"  id="valore" name="valore">
                                        </label>
                                        <div class="note">
                                            Il formato da seguire è gg/mm/aaaa  hh:mm   
                                        </div>
                                    </section>
                                    <section>
                                        <label class="label">2) Manda a questo utente:</label>
                                        <label class="input">
