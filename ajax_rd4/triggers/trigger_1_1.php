...
$sql = "SELECT * from retegas_triggers WHERE id_owner=:id_owner AND tipo=1 AND sottotipo=1;";
$stmt = $db->prepare($sql);
...
?>
                        ...
                        <div class="row padding-10">
                            ...
                            <form id="trigger_1_1" action="ajax_rd4/triggers/_act.php" novalidate="novalidate" method="POST" class="smart-form ">
                                <header>
                                    <strong>Funzione: </strong>Messaggio mail al raggiungimento n scatole piene in un determinato ordine;<br>
                                ...
                                <fieldset class="col col-md-6">
                                    ...
                                    <?php }?>
                                    <section>
                                        <label class="label">2) Si raggiungono queste scatole complete:</label>
                                        <label class="input">
                                            <input type="text" maxlength="10" id="soglia_scatole" name="soglia_scatole">
                                        </label>
                                        <div class="note">
                                        <strong>NB:</strong> al raggiungimento di questa soglia l'ordine comunque rimarrà aperto.    
                                        </div>
                                    </section>
                                    <section>
                                ...
                                <fieldset class="col col-md-6">
                                    ...
                                    <section>
                                        ...
                                        <label class="textarea">                                         
                                            <textarea rows="4" class="custom-scroll" id="summernote_trigger_1_1"></textarea> 
                                        </label>
                                        <div class="note">
...
<script type="text/javascript">
    ...
    loadScript("js_rd4/plugin/tablesorter/js/jquery.tablesorter.widgets.js",startTable);
        function startTable(){    
                ...
                var $table = $('#tabella_trigger_1_1').tablesorter({
                    theme: 'bootstrap',
                        //debug:true,
    ...
    $('#summernote_trigger_1_1').summernote({
            height : 180,
            focus : false,
            tabsize : 2,
            toolbar: [
    ...
    //FORM----------------------------------------------------------------    
    var $trigger_1_1 = $('#trigger_1_1').validate({
        
            rules : {id_ordine:{required : true},soglia_scatole:{required : true}, name:{required:true}},
            messages : {id_ordine : {required : 'Per cortesia inserisci qualcosa...'},soglia_scatole:{required : 'non scherziamo, dai....'},name:{required:'Serve un nome'}},
            submitHandler : function(form) {
                
                $(form).ajaxSubmit({
                    type:"POST",
                    dataType: 'json',
                    data: {id_ordine:$('#id_ordine').val(),id_target:$('#idUtente').val(), messaggio: $('#summernote_trigger_1_1').summernote('code'), act:'save_trigger_1_1'},
