...
<div class="row">
    <div class="col col-md-4">
        <div class="well well-sm well-light">
            <a class="btn btn-block btn-primary font-lg" href="#ajax_rd4/rettifiche/totale.php?id=<?php echo $id_ordine ?>">Totale ordine</a><br>
            <p class="">Immetti soltanto la cifra del totale ordine (quella che hai pagato al fornitore).</p>
        </div>
    </div>
    <div class="col col-md-4">
        <div class="well well-sm well-light">
            <a class="btn btn-block btn-primary font-lg" href="#ajax_rd4/rettifiche/utenti.php?id=<?php echo $id_ordine ?>">Totale utente</a><br>
            <p class="">Inserisci la cifra complessiva che ogni utente ha speso.</p>
        </div>
    </div>
    <div class="col col-md-4">
        <div class="well well-sm well-light">
            <a class="btn btn-block btn-primary font-lg" href="#ajax_rd4/rettifiche/dettaglio.php?id=<?php echo $id_ordine ?>">Dettaglio</a><br>
...
<div class="row">
    <div class="col col-md-4">
        <div class="well well-sm well-light">
            <a class="btn btn-block btn-primary" href="#ajax_rd4/rettifiche/articoli.php?id=<?php echo $id_ordine ?>">Articoli &amp; Scatole</a><br>
